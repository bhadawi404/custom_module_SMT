...
class SMTPurchaseOrderSupplier(models.Model):
    ...
    view_purchase_line_ids = fields.One2many('smt.purchase.order.supplier.line', 'purchase_order_id', string='Item Description')
    discount = fields.Float('Discount')
    net = fields.Float('Net', compute='_compute_net')
    tax = fields.Float('Tax', compute='_compute_tax', readonly=True)
...
class SMTPurchaseOrderSupplierLine(models.Model):
    ...
    product_id = fields.Many2one('smt.master.data.product', string='Product', required=True)
